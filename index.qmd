...
-   The solutions files as Quarto files (`.qmd`) are available in the R folder on [github](https://github.com/multi-state-book/companion){target="_blank"}. SAS solutions are also available as `.sas` files -- see the individual exercises.
