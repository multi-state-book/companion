...
| `tment`       | randomised treatment: 0 = placebo, 1 = CyA                                                  |
| `sex`         | 0 = female, 1 = male                                                  |
| `age`         | age in years                                                           |
...
||                1 = recurrent event |
||                2 = death  |
| `type`        | Type of recurrent events:
|               |'recurrent_mi' = recurrent MIs
|               |'recurrent_comb' = recurrent MACEs |
| `eventno`     | Event number  |
| `treat`       | randomised treatment: 0 = placebo, 1 = liraglutide|
