...
### In-text: Poisson model with treatment only (and time) {#sec-ch2-pbc3-poisson}

::: panel-tabset
## R

```{r}
#| label: in-text-poisson-r
#| results: hold
library(stats)
...
```{r}
#| label: in-text-stratified-cox-r
...
```{sas}
#| label: in-text-stratified-cox-sas
#| eval: false 
#| output: false
...
### In-text: simple Aalen model

::: panel-tabset
## R

```{r}
#| label: in-text-simple-aalen-r
#| out-width: 90%
...
### In-text: Aalen models

::: panel-tabset
## R

```{r}
#| label: aalen-models-r
# In-text
...
### In-text: additive Poisson model
...
```{sas}
#| label: in-text-additive-pois-sas
#| eval: false 
#| output: false
